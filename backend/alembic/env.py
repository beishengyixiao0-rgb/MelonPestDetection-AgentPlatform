...
# Alembic 通过对⽐ Base.metadata 和数据库当前状态来生成迁移脚本
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        literal_binds=True,  # 将参数值直接嵌⼊ SQL（便于生成独立脚本）
        dialect_opts={"paramstyle": "named"},  # 使用命名参数⻛格
    )
