...
@router.post("/create", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def create_dataset(
    data: DatasetCreate,
...
@router.get("/detail/{dataset_id}", response_model=DatasetResponse, openapi_extra={"security": [{"BearerAuth": []}]})
...
@router.post("/{dataset_id}/upload/images", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def upload_images(
    dataset_id: int = Path(..., ge=1),
...
@router.post("/{dataset_id}/upload/labels", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def upload_labels(
    dataset_id: int = Path(..., ge=1),
...
@router.post("/{dataset_id}/convert", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def convert_yolo(
    dataset_id: int = Path(..., ge=1),
    db: Session = Depends(get_db),
    current_user=Depends(require_admin),
...
@router.get("/{dataset_id}/images", response_model=PageResponse, summary="获取图片列表", openapi_extra={"security": [{"BearerAuth": []}]})
def get_images(
    dataset_id: int = Path(..., ge=1),
    page: int = Query(1, ge=1),
    page_size: int = Query(20, ge=1, le=100),
...
@router.get("/images/{image_id}", response_model=DatasetImageResponse, summary="获取单张图片详情", openapi_extra={"security": [{"BearerAuth": []}]})
def get_image(
...
@router.delete("/images/{image_id}", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def delete_image(
    image_id: int = Path(..., ge=1),
    db: Session = Depends(get_db),
    current_user=Depends(require_admin),
...
@router.get("/{dataset_id}/labels", response_model=PageResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def get_labels(
    dataset_id: int = Path(..., ge=1),
...
@router.get("/{dataset_id}/statistics", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def get_statistics(
    dataset_id: int = Path(..., ge=1),
    db: Session = Depends(get_db),
    current_user=Depends(require_admin),
...
@router.get("/{dataset_id}/summary", response_model=DatasetStatistics, openapi_extra={"security": [{"BearerAuth": []}]})
...
@router.post("/{dataset_id}/split", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def split_dataset(
    dataset_id: int = Path(..., ge=1),
...
@router.post("/{dataset_id}/export", openapi_extra={"security": [{"BearerAuth": []}]})
def export_dataset(
    dataset_id: int = Path(..., ge=1),
...
@router.delete("/{dataset_id}", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
def delete_dataset(
    dataset_id: int = Path(..., ge=1),
    db: Session = Depends(get_db),
    current_user=Depends(require_admin),
...
@router.post("/{dataset_id}/upload/zip", response_model=ApiResponse, openapi_extra={"security": [{"BearerAuth": []}]})
