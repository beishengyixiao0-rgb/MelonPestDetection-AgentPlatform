...
class DetectionService:
    ...
    def detect_zip(
        ...
        """
        解压 ZIP 文件并批量检测其中所有图片task.annotated_image_url = annotated_image_url  # ❌ DetectionTask 表没有这个字段task.annotated_image_url = annotated_image_url  # ❌ DetectionTask 表没有这个字段task.annotated_image_url = annotated_image_url  # ❌ DetectionTask 表没有这个字段
